        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('mahasiswa.store') }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="nim" class="w-full border border-gray-300 rounded px-3 py-2" required>
                </div>
                <div class="mb-5">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="jurusan" class="w-full border border-gray-300 rounded px-3 py-2" required> 
                </div>
                <div class="mb-5">  
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Angkatan</label>
                    <input type="number" name="angkatan" class="w-full border border-gray-300 rounded px-3 py-2" required>          
                </div>
                <div class="mb-5">
